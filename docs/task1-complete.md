...
| 页面 | 状态 | 文件路径 |
|------|------|----------|
| /guide/export-schedule | 完成 | src/app/guide/export-schedule/page.tsx |
| /schedule/import | 已有入口 | src/app/schedule/import/page.tsx |
| /schedule | 已添加帮助卡片 | src/app/schedule/page.tsx |

### 组件
| 组件 | 状态 | 文件路径 |
|------|------|----------|
| ScheduleExportCard | 完成 | src/components/guide/ScheduleExportCard.tsx |

### 入口位置
| 位置 | 状态 | 说明 |
|------|------|------|
| 课表页头部 | 完成 | "导出教程"按钮 |
| 课表导入页 | 完成 | "如何从教务系统导出课表？"链接 |
| 移动端侧边栏 | 完成 | "课表导出教程"菜单项 |
| 课表页空状态 | 完成 | 空状态双按钮（导入课表/查看导出教程） |
| 课表页帮助卡片 | 完成 | ScheduleExportCard 组件展示 |
