...
def analyze_structure(text):
    ...
    for i, line in enumerate(lines):
        if line.strip():
            print(f"行{i}: [{len(line):3d}字符] {line[:80]}{'...' if len(line) > 80 else ''}")
    ...
    # 观察：课程名 + ☆ 在一行，详情在下一行开始
    # 例如：
    # "大学英语 D2☆ 高等数学 C2☆ Web 前端开发☆ ..."
    # "(1-2 节)1-2 周，4-6 周 (双),7- (1-2 节)1-2 周，4-13 周..."
